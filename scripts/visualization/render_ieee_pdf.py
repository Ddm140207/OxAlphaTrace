...
# ---- abstract ----
E.append(Paragraph("Abstract\u2014We present a reproducible, behavior-only investigation of \u201cOx Alpha\u201d (openrouter/stealth/ox-alpha), a stealth-served language model of undisclosed provenance. Phase I benchmarks the session subject across 209 trials: identity probing (n=100 incl. adversarial frames), 13-language generation, reasoning (19/20), reasoning consistency (RCS = 1.00), prompt sensitivity (8/8, 33x verbosity compliance, zero sycophancy), refusal structure (8/8 mechanistic templates), knowledge calibration (15/15, zero hallucinations), and cross-language coding (7/7); two independent LLM raters agreed exactly on every scored dimension. Phase II tests provenance via a twelve-probe meta-cognition battery administered identically to the live stealth route and seven reference models, with three-trial seed replication on diagnostic probes. Raters converge on a two-tier solution: DeepSeek V4 Flash ranks first (8.5/10; unique stable fingerprint \u2014 the exact second arithmetic verification route 30x43\u22123x43 = 1161 reproduced in 3/3 trials), followed by GLM-5.2 (6.0\u20137.5/10; byte-identical humor output and isomorphic labeled-phase narration). US-lab candidates rank lower (GPT-5.6-Luna 4.0\u20136.5; Qwen 3.5\u20135.5; Claude Haiku unstable; Grok 3.0\u20133.5). Blind attribution yielded identical rater partitions (ARI = 1.00) but mutual indistinguishability between the stealth route and OpenCode\u2019s big-pickle, which reproducibly self-identifies as ox-alpha. Per pre-registration, no behavioral result establishes lineage.", S["absx"]))
