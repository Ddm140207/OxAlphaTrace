...
\author{\IEEEauthorblockN{Diego D\'iaz Montero}\\
\IEEEauthorblockA{OxAlphaTrace --- Behavioral Fingerprinting Study\\ Subject: Ox Alpha (stealth route); Raters: Nemotron 3 Ultra, DeepSeek V4 Flash, Big Pickle\\ OpenCode CLI harness --- collection window: August 23, 2026 --- fully reproducible from repository}}
